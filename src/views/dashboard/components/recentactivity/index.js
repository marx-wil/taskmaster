        ...
        <Flex align="center" py={2}>
            ...
            <Box>
                <Text fontSize="sm" color={contentTextColor}>
                    <Text as="span" fontWeight="bold">{activity.user}</Text> {activity.action}
                </Text>
...
const RecentActivity = () => {
    ...
    const userData = {
        recentActivity: [
            { id: 1, user: 'John Doe', action: 'created a new project', time: '2 hours ago', avatar: 'https://via.placeholder.com/150' },
            { id: 2, user: 'Jane Smith', action: 'updated the project', time: '1 hour ago', avatar: 'https://via.placeholder.com/150' },
        ],
    };
    return (
