...
const DesktopNav = () => {
    ...
    const linkHoverColor = useColorModeValue('#7551FF', '#7551FF')
    const popoverContentBgColor = useColorModeValue('#ffffff', '#0B1437')
...
const MobileNav = () => {
    return (
        <Stack bg={useColorModeValue('#ffffff', '#0B1437')} p={4} display={{ md: 'none' }}>
            {NAV_ITEMS.map((navItem) => (
