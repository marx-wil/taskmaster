    ...
    <Box py={12}>
      <VStack spacing={2} textAlign="center">
        ...
        <Text fontSize="lg" color={'gray.500'} className="poppins-regular">
          TaskMaster is 100% free to use — no hidden charges, ever. If you need
          <br />
        ...
        <PriceWrapper>
          <Box py={4} px={12}>
            ...
            <HStack justifyContent="center">
              <Text fontSize="3xl" fontWeight="600" className="poppins-regular">
                $
              </Text>
              <Text fontSize="5xl" fontWeight="700" className="poppins-regular">
                0
              </Text>
              <Text fontSize="3xl" color="gray.500" className="poppins-regular">
                /month
              </Text>
            </HStack>
          </Box>
