...
const Logo = props => {
  return (
    <Text fontSize={'2xl'} fontWeight={'bold'} className="poppins-bold">
      TaskMaster
    </Text>
  );
};
      ...
      <Container as={Stack} maxW={'6xl'} py={10}>
        ...
        >
          ...
          <Stack align={'flex-start'}>
            <ListHeader className="poppins-semibold" fontWeight={'600'}>
              Company
            </ListHeader>
          ...
          <Stack align={'flex-start'}>
            <ListHeader className="poppins-semibold" fontWeight={'800'}>
              Stay up to date
            </ListHeader>
            <Stack direction={'row'}>
              <Input
